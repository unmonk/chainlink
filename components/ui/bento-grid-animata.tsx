  ...
  return (
    <BentoCard className="flex flex-col bg-yellow-300">
      ...
      <div className="mt-auto flex justify-end">
        <div className="text-4xl font-black text-black/60 md:text-7xl"></div>{" "}
...
function FeatureTwo() {
  return (
    <BentoCard className="relative flex flex-col overflow-visible bg-violet-500 sm:col-span-2">
      <strong className="text-2xl font-semibold text-white"></strong>
      <div className="ml-4 mt-auto"></div>
    </BentoCard>
  );
}
...
function FeatureFour() {
  return (
    <BentoCard className="flex items-center gap-4 bg-lime-300 sm:col-span-2 md:flex-row-reverse">
      ...
      <div className="relative max-h-32 flex-shrink-0 overflow-hidden"></div>
    </BentoCard>
  );
}
