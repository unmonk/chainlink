...
export default function AddToOtherBrowser(props: Props) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-[60%] z-50 pb-12 px-4 text-foreground bg-background border rounded-lg border-foreground flex flex-col items-center justify-around">
